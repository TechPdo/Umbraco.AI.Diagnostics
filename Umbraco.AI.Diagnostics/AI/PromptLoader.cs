  ...
  ""items"": [
    {
      ...
      ""logLevel"": ""The log level from that entry (Verbose, Debug, Information, Warning, Error, or Fatal — copy from the log line)"",
...
Guidelines:
- Every item must include logLevel taken from the bracketed level in each log line (e.g. [Error], [Warning], [Information]).
